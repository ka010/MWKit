...
-(void)didReceiveData:(const char*)data {
    ...
    if (msgType==kMSG_TYPE_GET_DEVICE_TYPE_RESPONSE) {
        ...
        self.logString = [self.logString stringByAppendingFormat:@"Button %@ pressed. \n",[NSNumber numberWithChar:data[3]]];

        [[NSNotificationCenter defaultCenter]postNotificationName:MWKitDidReceivePuttonPress object:[NSNumber numberWithChar:data[3]]];
